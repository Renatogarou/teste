...
class EstadosHelper extends AppHelper {
     ...
     */
   public function select($fieldName, $selected = null, $attributes = array(),$label='UF') {
        ...
        return $this->Form->input($fieldName,array('options'=> $options,'selected'=>$selected,$attributes,'label'=>$label));
    }
